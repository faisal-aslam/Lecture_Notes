...
regular expressions and finite automata -- is Lectures 4--6.
\end{coreidea}
...
\begin{enumerate}
  ...
  tokens (built from finite automata, Lectures 5--6) are considerably faster than the
  general-purpose parsing techniques (Lectures 8 onward) would be if forced to operate
...
\begin{itemize}
  ...
  letters and digits.'' Lectures 4--6 make patterns precise using regular expressions.
...
scanner implements it efficiently, once we cover finite automata in Lectures 5--6.
\end{enrichment}
...
specification must include -- one more reason lexer-generator tools (Lecture 7) are preferred
over hand-written code once a language's literal syntax grows this rich.
\end{enrichment}
...
\begin{itemize}
  \item [DB] Aho, Lam, Sethi, Ullman. \textit{Compilers: Principles, Techniques, and Tools}, 2nd ed., \S3.1, \S3.3.
  \item [AP] Appel. \textit{Modern Compiler Implementation in C/Java/ML}, Ch.\,2.
\end{itemize}
