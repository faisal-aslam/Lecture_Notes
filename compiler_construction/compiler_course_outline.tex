...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{ l X l X }
        ...
        & & & Theory of Automata \\
        \multicolumn{4}{l}{\textbf{Instructors:} Farooq Ahmad, Faisal Aslam, Aamir Raheem, Hamad Ulqudous} \\
    \end{tabularx}
    \label{tab:Intro}
\end{table}
\vspace{-1cm}
...
\multicolumn{5}{|c|}{\cellcolor{gray!20}\textbf{Unit 2: Lexical Analysis (6 Lectures)}} \\ \hline
...
\rowcolor{blue!8}
Opt.1 & \emph{\textbf{[Optional -- instructor's tool choice: Flex]}} Building the L7 lexer concretely with Flex. \emph{Not part of Midterm 1 -- assessed via the project.} & CLO3 & (tool choice for \S3.5, \S3.8) & --- \\ \hline
...
\multicolumn{5}{|c|}{\cellcolor{gray!20}\textbf{Unit 2 (cont.): Lexical Analyzer Construction (Lecture 10)}} \\ \hline
10 & Input buffering: two-buffer scheme, \texttt{lexeme\_begin} and \texttt{forward} pointers; recognition of tokens via transition diagrams and transition tables; hand-coding a lexical analyzer from a transition diagram & CLO1, CLO3 & \S3.2, \S3.4 & [AP] \S2.2 \\ \hline

\multicolumn{5}{|c|}{\cellcolor{yellow!25}\textit{--- Midterm 1 (after Lecture 10; covers L1--L10) ---}} \\ \hline

\multicolumn{5}{|c|}{\cellcolor{gray!20}\textbf{Unit 3a (cont.): Context-Free Grammars \& Top-Down Parsing (Lecture 11)}} \\ \hline
11 & Grammar engineering II: removing ambiguity (e.g.\ dangling-else), disambiguation techniques, non-CFG constructs; top-down parsing overview and recursive-descent parsing & CLO1, CLO2, CLO3 & \S4.3.3, \S4.3, \S4.4.1 & [GR] Ch.4; [AP] \S3.2 \\ \hline

\multicolumn{5}{|c|}{\cellcolor{gray!20}\textbf{Unit 3b: Parsing Algorithms (Lectures 12--17)}} \\ \hline
