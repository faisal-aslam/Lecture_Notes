...
4 & Regular languages vs. non-regular languages; regular expressions with examples & CLO1 & \S3.3, \S3.4 & [PP] \S3.3 \\ \hline
5 & Finite automata; RE $\to$ NFA (Thompson's Construction) & CLO1, CLO2 & \S3.6, \S3.7 (Alg.~3.23) & [AP] \S2.3--2.4 \\ \hline
6 & NFA $\to$ DFA (subset construction); DFA minimization; NFA vs.\ DFA power/performance & CLO1, CLO2 & \S3.7, \S3.9 (Alg.~3.20, 3.36) & [ET] \S2.4--2.5 \\ \hline
...
\multicolumn{5}{|c|}{\cellcolor{gray!20}\textbf{Unit 3a: Context-Free Grammars (Lectures 8--9)}} \\ \hline
8 & Context-free grammars; derivations; parse trees; ambiguity & CLO1 & \S4.1--\S4.2, \S4.3.3 & [GR] Ch.4 \\ \hline
9 & Grammar engineering: eliminating left recursion, left factoring, non-CFG constructs & CLO1, CLO2 & \S4.3 & [ET] \S3.5 \\ \hline

\multicolumn{5}{|c|}{\cellcolor{gray!20}\textbf{Unit 3b: Parsing Algorithms (Lectures 10--17)}} \\ \hline
10 & Top-down parsing overview; recursive-descent parsing & CLO1, CLO3 & \S4.4.1 & [AP] \S3.2 \\ \hline
\multicolumn{5}{|c|}{\cellcolor{yellow!25}\textit{--- Midterm 1 (after Lecture 10; covers L1--L10) ---}} \\ \hline
11 & FIRST and FOLLOW sets; LL(1) parsing-table construction & CLO1, CLO2 & \S4.4.2--\S4.4.4 & [ET] \S3.3 \\ \hline
12 & LL(1) predictive-parsing algorithm; panic-mode \& phrase-level error recovery & CLO2, CLO3 & \S4.4.3, \S4.4.5--\S4.4.9 & [PP] \S3.4.5 \\ \hline
13 & Bottom-up parsing: shift-reduce parsing, handles, shift-reduce \& reduce-reduce conflicts & CLO1, CLO2 & \S4.5 & [AP] \S3.3 \\ \hline
14 & LR(0) items \& automaton; SLR parsing & CLO2 & \S4.6 & [ET] \S3.4.1--3.4.2 \\ \hline
15 & Canonical LR(1) items and CLR parsing tables & CLO2 & \S4.7.1--\S4.7.2 & [ET] \S3.4.3 \\ \hline
16 & \textbf{LALR(1) parsing} --- the industry-standard, state-of-the-art table-driven algorithm (used by Yacc/Bison) & CLO2 & \S4.7.3--\S4.7.5 & [ET] \S3.4.4; [AN] Ch.1 \\ \hline
...
21 & Symbol tables, scope resolution, static semantic checking & CLO1, CLO2 & \S2.7, \S6.3 & [AP] Ch.5 \\ \hline
