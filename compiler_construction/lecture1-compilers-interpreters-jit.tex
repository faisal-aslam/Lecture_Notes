...
\begin{enumerate}
  ...
  needed both for dynamically linked libraries (previewed in Lecture 2) \emph{and}, on modern
  systems, for the main executable itself when it is position-independent (see the box below);
  and
