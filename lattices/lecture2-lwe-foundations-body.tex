...
\begin{tikzpicture}[scale=1, every node/.style={font=\small}]
  ...
  \node[draw, minimum width=6.6cm, minimum height=1.1cm, fill=purple!6, align=center] (owf) at (2.6,2.0) {\textbf{One-way function, with a trapdoor}\\ \tiny average-case, provably as hard as SVP/CVP};
  ...
  \draw[-{Latex[length=2mm]}] (owf.south east) -- (enc.north);
\end{tikzpicture}
