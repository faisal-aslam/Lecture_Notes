...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Looking ahead:} skim the abstract of one published Kyber side-channel paper of your choosing (we will assign specific ones in Session 5) and identify which single line of the algorithms in Section~\ref{sec:L3:the-cpa-secure-core-kyber-cpapke} of this lecture it targets --- KeyGen, Enc, Dec, or the FO check in Section~\ref{sec:L3:from-cpa-secure-encryption-to-a-cca-secu}.
\end{enumerate}
\end{exercisebox}
