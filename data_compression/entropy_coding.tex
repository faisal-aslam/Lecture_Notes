...
\textbf{Next Lectures:}
\begin{enumerate}
    \item \textbf{Dictionary Methods}: LZ77, LZ78, LZW - the other pillar of compression
    \item \textbf{Transform Coding}: DCT, wavelets for lossy compression
    \item \textbf{Modern Standards}: Brotli, Zstandard, JPEG XL
\end{enumerate}

\textbf{The Two Pillars of Compression:}
\begin{center}
\begin{tikzpicture}[node distance=2cm]
\node (comp) [rectangle, draw=black, thick, minimum width=6cm, minimum height=2cm] {\textbf{Data Compression}};
\node (entropy) [below left=1cm of comp.south, rectangle, draw=blue, thick, fill=blue!5, minimum width=2.5cm] {\parbox{2.5cm}{\centering \textbf{Entropy Coding}\\Statistical\\Huffman, Arithmetic}};
\node (dictionary) [below right=1cm of comp.south, rectangle, draw=red, thick, fill=red!5, minimum width=2.5cm] {\parbox{2.5cm}{\centering \textbf{Dictionary Coding}\\Repetition-based\\LZ family}};
\draw[->, thick, blue] (comp.south) -- (entropy);
\draw[->, thick, red] (comp.south) -- (dictionary);
\end{tikzpicture}
\end{center}
