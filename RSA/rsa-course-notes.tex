...
%     standalone document -- it gets its content from
%     lectureN-rsa-*-body.tex via \input. The standalone lecture files
%     no longer carry their own title page or table of contents (that
%     used to be duplicated per lecture); the shared title text lives
%     in ONE place (\seriestitle, defined in lecture-preamble.tex) and
%     the single combined table of contents below is the only one,
%     covering all three lessons together at the top of this document.
