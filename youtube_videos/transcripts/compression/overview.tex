...
\end{forest}
\caption{The transform-based branch. BWT doesn't compete
...
is still collapsed on purpose; we expand it in Part 9.}
...
\end{forest}
\caption{The complete tree, lossy half, from Part 9.
